...
export const EXERCISES = [
  ...
  // Logique intermédiaire – Déduction
  ...
  { id: 105, type: "Logique intermédiaire – Déduction", difficulty: 2, question: "Tous les sportifs courent. Pierre court. Peut-on conclure que Pierre est sportif ?", answer: "non", explanation: "Erreur classique : l’inverse n’est pas garanti." },
  ...
  { id: 111, type: "Logique intermédiaire – Logigrammes", difficulty: 2, question: "Trois amis (Ana, Ben, Léo) ont chacun un animal différent (chat, chien, poisson). Ana n’a pas de chat. Ben n’a pas de chien. Qui a le chien ?", answer: "Ana", explanation: "En testant les possibilités, seul Ana peut avoir le chien." },
  { id: 112, type: "Logique intermédiaire – Logigrammes", difficulty: 2, question: "Trois élèves (Clara, Hugo, Inès) pratiquent chacun un sport différent (tennis, natation, judo). Clara ne fait pas de judo. Hugo ne fait pas de natation. Qui fait de la natation ?", answer: "Inès", explanation: "Par élimination, la natation revient à Inès." },
  { id: 113, type: "Logique intermédiaire – Logigrammes", difficulty: 2, question: "Quatre jours (lundi, mardi, mercredi, jeudi) et quatre matières (maths, français, histoire, sciences). Les maths ne sont pas lundi. Le français est après les maths. Les sciences ne sont pas jeudi. Quel jour peut être les maths ?", answer: "mardi", explanation: "Mardi permet de placer français après et sciences avant jeudi." },
  ...
  // Logique intermédiaire – Temps & travail
